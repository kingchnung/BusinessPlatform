...
public class SalesItem {
    ...
    @JoinColumn(name = "sales_no", referencedColumnName = "salesNo", nullable = false)
    @JsonBackReference
    private Sales sales;

    @Column(name = "SALES_NO", nullable = false, insertable = false, updatable = false) // (NOT NULL일 수 있으니 확인 필요)
