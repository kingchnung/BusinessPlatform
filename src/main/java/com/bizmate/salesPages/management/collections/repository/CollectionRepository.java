...
public interface CollectionRepository extends JpaRepository<Collection, String>, CollectionRepositoryCustom, EnversRevisionRepository<Collection, String, Integer> {
