...
public class ProjectMemberServiceImpl implements ProjectMemberService {
    ...
    public void register(ProjectMemberRequestDTO requestDTO) {
        ...
        if(projectMemberRepository.existsByProjectId_ProjectIdAndUserId_UserId(requestDTO.getProjectId() , requestDTO.getUserId())){
    ...
    private ProjectMember getProjectMember(Long projectId, Long userId){
        ...
        ProjectMember projectMember = projectMemberRepository.findById(id)
                .orElseThrow(() -> new ProjectMemberException("수정할 프로젝트 멤버가 존재하지 않습니다."));
    ...
    private List<ProjectMemberResponseDTO> getDtoList (List<ProjectMember> list){
        try {
            ...
            throw  new ProjectMemberException("프로젝트 멤버를 조회할 수 없습니다." );
        }
    }
    ...
    private ProjectMemberResponseDTO toDTO(Long projectId, Long userId){
        ...
        ProjectMember projectMember = projectMemberRepository.findById(projectMemberId)
                .orElseThrow(() -> new ProjectMemberException("프로젝트 멤버를 조회할 수 없습니다."));
    ...
    private Project getProject(Long id){
            return projectRepository.findById(id)
                    .orElseThrow(() -> new ProjectMemberException("프로젝트 정보를 불러오지 못 했습니다" ));
    ...
    private UserEntity getUser(Long id){
            return  userRepository.findById(id)
                    .orElseThrow(() -> new ProjectMemberException("사용자를 불러올 수 없습니다."));
    }
